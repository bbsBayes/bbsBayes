...
#' @param regions vector selcting regional compilation(s) to calculate, options include "continental","stratum", national", "prov_state", or "bcr", or any combination of these
...
generate_regional_indices <- function(jags_mod = NULL,
                                  ...
                                  regions = c("national", "prov_state","bcr","stratum","continental"),
                                  alternate_n = "n")
{
  if (is.null(jags_mod))
  {
