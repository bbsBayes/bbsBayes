...
#'
#' @param indices regional indices generated by `generate_indices()`
#' @param min_year Numeric. Minimum year to calculate trends from (e.g., 1970).
#'   Default (`NULL`) uses first year in data.
#' @param max_year Numeric. Maximum year to calculate trends to (e.g., 2018).
#'   Default (`NULL`) uses last year in data.
