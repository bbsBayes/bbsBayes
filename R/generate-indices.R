...
#'
#' @param model_output JAGS list generated by \code{run_model}
...
#' @param alt_region_names Optional dataframe indicating the strata to include
#'   in a custom spatial summary. Generate the basic dataframe structure with
#'   the \code{extract_strata_areas} function, then modify with an additional
#'   column indicating the strata to include in a custom spatial summary
#'
#' @return List of 6 objects
#'   \item{data_summary}{dataframe with the following columns}
#'   \item{Year}{Year of particular index}
