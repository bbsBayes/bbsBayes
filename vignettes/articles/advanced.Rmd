...
```{r}
prepped_data <- prepare_data(s, min_max_route_years = 5)
```
...
```{r}
mod <- run_model(prepped_data, 
                 model = "gamye",
                 heavy_tailed = TRUE, 
                 iter_sampling = 10, iter_warmup = 10, chains = 2)
readr::write_rds(mod, "cws_bars_gamye.rds")
```

Alternatively, you can set how many iterations for sampling or warmup steps, 
...
draws, convergence information, data, etc.
