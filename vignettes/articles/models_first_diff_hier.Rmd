...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpATuXX9/model-fc1b461ae38c.stan', line 227, column 3 to column 40)
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpATuXX9/model-fc1b461ae38c.stan', line 227, column 3 to column 40)
...
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes/vignettes/articles/BBS_STAN_first_diff_hier_2023-01-06_01.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__          1.85        10       10
#>  2 strata_raw    strata_raw[1] 1.52        10       10
#>  3 strata_raw    strata_raw[2] 1.21        10       10
#>  4 strata_raw    strata_raw[3] 1.09        10       10
#>  5 strata_raw    strata_raw[4] 0.994       10       10
#>  6 strata_raw    strata_raw[5] 1.17        10       10
#>  7 strata_raw    strata_raw[6] 1.22        10       10
#>  8 strata_raw    strata_raw[7] 1.01        10       10
#>  9 strata_raw    strata_raw[8] 1.53        10       10
#> 10 strata_raw    strata_raw[9] 1.23        10       10
...
#> [1] "BBS_STAN_first_diff_hier_2023-01-06_01.rds" "BBS_STAN_first_diff_hier_2023-01-06-1.csv" 
#> [3] "BBS_STAN_first_diff_hier_2023-01-06-2.csv"
