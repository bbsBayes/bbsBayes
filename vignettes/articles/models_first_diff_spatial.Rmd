...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpATuXX9/model-fc1b63088f6f.stan', line 240, column 3 to column 40)
...
#> Chain 1
#> Chain 1 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Log location parameter[1] is inf, but must be finite! (in '/tmp/RtmpATuXX9/model-fc1b63088f6f.stan', line 240, column 3 to column 40)
#> Chain 1 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
#> Chain 1 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
#> Chain 1
#> Chain 1 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpATuXX9/model-fc1b63088f6f.stan', line 240, column 3 to column 40)
...
#> Chain 2
#> Chain 2 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Log location parameter[1] is -nan, but must be finite! (in '/tmp/RtmpATuXX9/model-fc1b63088f6f.stan', line 240, column 3 to column 40)
#> Chain 2 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
#> Chain 2 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
#> Chain 2
#> Chain 2 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
...
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes/vignettes/articles/BBS_STAN_first_diff_spatial_2023-01-06_01.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__           2.00       10       10
#>  2 strata_raw    strata_raw[1]  1.29       10       10
#>  3 strata_raw    strata_raw[2]  1.61       10       10
#>  4 strata_raw    strata_raw[3]  1.04       10       10
#>  5 strata_raw    strata_raw[4]  1.18       10       10
#>  6 strata_raw    strata_raw[5]  1.18       10       10
#>  7 strata_raw    strata_raw[6]  1.33       10       10
#>  8 strata_raw    strata_raw[7]  1.08       10       10
#>  9 strata_raw    strata_raw[8]  1.30       10       10
#> 10 strata_raw    strata_raw[9]  1.14       10       10
...
#> [1] "BBS_STAN_first_diff_spatial_2023-01-06_01.rds" "BBS_STAN_first_diff_spatial_2023-01-06-1.csv" 
#> [3] "BBS_STAN_first_diff_spatial_2023-01-06-2.csv"
