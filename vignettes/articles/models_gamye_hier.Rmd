...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpFromXy/model-f84146f8d342.stan', line 238, column 3 to column 40)
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpFromXy/model-f84146f8d342.stan', line 238, column 3 to column 40)
...
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes/vignettes/articles/BBS_STAN_gamye_hier_2022-12-16_01.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__          1.83        10       10
#>  2 strata_raw    strata_raw[1] 0.998       10       10
#>  3 strata_raw    strata_raw[2] 1.24        10       10
#>  4 strata_raw    strata_raw[3] 0.973       10       10
#>  5 strata_raw    strata_raw[4] 1.12        10       10
#>  6 strata_raw    strata_raw[5] 1.13        10       10
#>  7 strata_raw    strata_raw[6] 1.06        10       10
#>  8 strata_raw    strata_raw[7] 1.05        10       10
#>  9 strata_raw    strata_raw[8] 1.27        10       10
#> 10 strata_raw    strata_raw[9] 1.07        10       10
...
<img src="figures/gamye_hier_unnamed-chunk-8-1.png" alt="Grid of plots showing model indices over years for each regional division with blue lines and blue-grey ribbons to indicate the confidence intervals."  />
...
<img src="figures/gamye_hier_unnamed-chunk-9-1.png" alt="Map of North America showing the stratification areas colour-coded by trend."  />
...
<img src="figures/gamye_hier_unnamed-chunk-10-1.png" alt="A grid of plots in the shap of North America, with one plot per province or state. Each plot shows the indices over time."  />

## Reproducibility and Clean up

```r
list.files(pattern = "csv|rds")
#> [1] "BBS_STAN_gamye_hier_2022-12-16_01.rds" "BBS_STAN_gamye_hier_2022-12-16-1.csv" 
#> [3] "BBS_STAN_gamye_hier_2022-12-16-2.csv"
