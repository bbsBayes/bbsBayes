...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpATuXX9/model-fc1b24a7a546.stan', line 221, column 3 to column 40)
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpATuXX9/model-fc1b24a7a546.stan', line 221, column 3 to column 40)
...
#> Chain 1 finished in 99.1 seconds.
#> Chain 2 Iteration: 20 / 20 [100%]  (Sampling) 
#> Chain 2 finished in 119.5 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 109.3 seconds.
#> Total execution time: 119.6 seconds.
#> Warning: 2 of 2 chains had an E-BFMI less than 0.2.
#> See https://mc-stan.org/misc/warnings for details.
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes/vignettes/articles/BBS_STAN_slope_spatial_2023-01-06_01.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__           2.11       10       10
#>  2 strata_raw    strata_raw[1]  1.21       10       10
#>  3 strata_raw    strata_raw[2]  1.52       10       10
#>  4 strata_raw    strata_raw[3]  1.16       10       10
#>  5 strata_raw    strata_raw[4]  1.72       10       10
#>  6 strata_raw    strata_raw[5]  2.04       10       10
#>  7 strata_raw    strata_raw[6]  1.45       10       10
#>  8 strata_raw    strata_raw[7]  1.58       10       10
#>  9 strata_raw    strata_raw[8]  2.01       10       10
#> 10 strata_raw    strata_raw[9]  1.88       10       10
...
#> [1] "BBS_STAN_slope_spatial_2023-01-06_01.rds" "BBS_STAN_slope_spatial_2023-01-06-1.csv" 
#> [3] "BBS_STAN_slope_spatial_2023-01-06-2.csv"
